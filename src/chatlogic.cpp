...
ChatLogic::ChatLogic(const ChatLogic &source) {
    // Deep copy
    for(auto& it : source._nodes) {
        _nodes.push_back(make_unique<GraphNode>(*it));
    }
    ...
    *_chatBot = *source._chatBot;
    ...
    cout << "ChatLogic Copy Constructor" << endl;
}
...
ChatLogic& ChatLogic::operator=(const ChatLogic &source){
    ...
    *_chatBot = *source._chatBot;
    ...
    cout << "ChatLogic Copy Assignment Operator" << endl;
}
...
ChatLogic::ChatLogic(ChatLogic &&source) {
    ...
    cout << "ChatLogic Move Constructor" << endl;
}
...
ChatLogic& ChatLogic::operator=(ChatLogic &&source){
    ...
    cout << "ChatLogic Move Assignment Operator" << endl;
}
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            auto const& parentNode = std::find_if(_nodes.begin(), _nodes.end(), [&parentToken](unique_ptr<GraphNode>& node) { return node.get()->GetID() == std::stoi(parentToken->second); });
                            auto const& childNode = std::find_if(_nodes.begin(), _nodes.end(), [&childToken](unique_ptr<GraphNode>& node) { return node.get()->GetID() == std::stoi(childToken->second); });
